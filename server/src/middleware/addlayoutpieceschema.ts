...
export const addLayoutPieceSchema = [
  body('connectionName')
    .notEmpty().isString()
    .withMessage("JSON parameter 'connectionName' should be a string")
    .isIn(["start", "end", "diverge"])
    .withMessage("JSON parameter 'connectionName' should have one of the following values: 'start', 'end', 'diverge'"),
