 ...
 */
export function calculateStraightCoordinate(
  otherCoordinate: Coordinate,
  length: number,
  heading: number
): {coordinate: Coordinate, heading: number} {
 ...
 * @param curve The side that the curve curves to, as seen from the "otherCoordinate"
 * @returns {coordinate, heading}
 */
export function calculateCurveCoordinate(
  otherCoordinate: Coordinate,
  otherHeading: number,
  angle: number,
  radius: number,
 ...
 * @returns {coordinate, heading}
 */
export function calculateCurveRightCoordinate(
  otherCoordinate: Coordinate,
  otherHeading: number,
  angle: number,
  radius: number
