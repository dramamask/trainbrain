...
import { deleteLayoutPieceSchema } from "../middleware/deletelayoutpieceschema.js";
...
router.delete('/piece/:index', deleteLayoutPieceSchema, validate, layoutController.deleteLayoutPiece);
