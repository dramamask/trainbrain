...
// The name of the CSS class of a container that surrounds the track piece SVG component
...
// The name of the CSS class of a node. Nodes are at the end of each track piece.
